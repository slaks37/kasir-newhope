...
const MIGRATIONS = [
  ...
  'migrations/0013_user_membership_identity_plane.sql',
  'migrations/0014_tenants_to_internal_platform.sql',
  'migrations/0015_model_b_tenant_merchant_outlet_hierarchy.sql',
